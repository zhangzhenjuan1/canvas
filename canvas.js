$(function(){
    ...
    //    $(this).find(".son").slideDown(400);
    //    $(this).css({background:"#fb404b"});
    //},function(){
    //    $(this).finish();
    //    $(this).find(".son").finish();
    //    $(this).find(".son").slideUp(400);
    //    $(this).css({background:"#42435a"});
    //});

        $(".hasson").click(function(e){
            $(this).finish();
           //$(this).find(".son").toggle(function(){
           //    $(this).find(".son").slideDown(400);
           //}
            //   ,funtion(){
            //    $(this).find(".son").slideUp(400);
            ...
            $(this).find(".son").finish();
            $(this).find(".son").slideToggle("slow");
            //e.preventDefault();
        });
    $(".hasson").onmousedown=function(e){
        e.preventDefault();
    }
